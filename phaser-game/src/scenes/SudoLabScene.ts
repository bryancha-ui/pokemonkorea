...
export class SudoLabScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.dialog.show([
      ...
      "Prof. Song: Team Suri wants to set off the Jeju vent and control it — to heal the region. Misguided, dangerous.",
      "Prof. Song: But 노스단 doesn't care about the vent itself. They want to be PRESENT when it erupts —",
      "Prof. Song: — to harvest the catastrophic eruption energy and weaponize it against the south.",
      ...
      "Prof. Song: If they can't harvest the Jeju vent directly, they'll use HER as a living battery instead.",
